...
import { Search, Filter, X, ShoppingCart, Star, Headphones as HeadphonesIcon } from 'lucide-react';
...
export default function Headphones() {
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      // Filter samo Headphones
      const headphonesOnly = response.data.filter((p: Product) => p.category === 'headphones');
      setProducts(headphonesOnly);
    } catch (error) {
      ...
      <>
        ...
        <div className="min-h-screen bg-neutral-900 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-xl font-semibold text-white">Loading headphones...</p>
          </div>
        </div>
      </>
    );
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-neutral-900">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-r from-green-900/20 to-teal-900/20 py-16">
          <div className="absolute inset-0 bg-gradient-to-br from-neutral-900/50 to-transparent"></div>
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 mb-4">
              <div className="bg-neutral-800 p-4 rounded-xl border border-neutral-700">
                <HeadphonesIcon className="w-12 h-12 text-indigo-400" />
              </div>
            ...
            <p className="text-lg text-neutral-400">
              Browse our collection of {products.length} premium headphones
            </p>
          </div>
        </section>
            ...
            <main className="flex-1">
              ...
              <div className="flex items-center justify-between mb-6">
                <p className="text-neutral-400">
                  ...
                  <span className="text-white font-semibold">{products.length}</span> headphones
                </p>
              </div>
              ...
              {filteredProducts.length === 0 ? (
                <div className="bg-neutral-800 rounded-xl border border-neutral-700 p-12 text-center">
                  <p className="text-xl text-neutral-400 mb-2">No headphones found</p>
